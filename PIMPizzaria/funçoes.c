...
printfOrdenado(" ________________         ________________         ________________ ",6,11);
printfOrdenado("|                |       |                |       |                |",6,12);
printfOrdenado("|________________|       |________________|       |________________|"NONE,6,13);pintar(15);
};
...
printfOrdenado(C_BLUE" __________________       ___________________       ___________________ ",4,7);
printfOrdenado("|                  |     |                   |     |                   |",4,8);
printfOrdenado("|__________________|     |___________________|     |___________________|"NONE,4,9);pintar(15);

};

void contornoPizzaiolo(){

printfOrdenado(C_BLUE" _______________________  ________________________  ________________________ ",2,7);
printfOrdenado("|                       ||                        ||                        |",2,8);
printfOrdenado("|_______________________||________________________||________________________|"NONE,2,9);pintar(15);
