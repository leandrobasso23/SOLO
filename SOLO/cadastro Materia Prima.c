...
typedef struct Produtos {
    ...
    int xx=0;
            ...
            contorno_BePeP();
            printfCenter("TELA DE MATERIA PRIMA",1);
            printfOrdenado("1-Novo Cadastro",8,ordenaMenu);
            printfOrdenado("2-Lista de Materia ",30,ordenaMenu);
        ...
        if(opp<0){
            ...
            strcpy(novo->categoria,"Materia");

            aux = inicio;
            ordenaMenu =3;
            contornoTelaComCabeca();
            printfCenter("Novo Cadastro",1);
    ...
    fclose(arq);
        ...
        contornoTela();
            ...
            printfOrdenado(C_WHITE"|        CADASTRADO COM SUCESSO            |"NONE,18,6);pintar(15);
            printfOrdenado(C_GREEN"|                                          |",18,7);
                   printfOrdenado("|******************************************|"NONE,18,8);pintar(15);
contornoCADASTRO();
            printfOrdenado("1. CADASTRAR OUTRO ",9,11);
        ...
        if(ott<0){
            ...
            if(ott==1){
                ...
                printf("\t%-40s|%-15s\n\n", "NOME", "ESTOQUE");
                while(aux != NULL){
                if(strcmp("Materia", aux->categoria) == 0){
                ...
                case 0: return cadastroMateria(); break;
        default:
